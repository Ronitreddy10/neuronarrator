 ...
 export const ControlDeck = ({ isActive, onToggle }: ControlDeckProps) => {
   return (
     <div className="fixed bottom-0 left-0 right-0 p-6 pb-8">
       <div className="glass-panel super-ellipse-sm p-4">
         <div className="flex items-center justify-between">
           ...
           <button
             onClick={onToggle}
             className="tactile-button relative w-20 h-20 rounded-full flex items-center justify-center group"
           >
             {/* Outer pulsing ring */}
             <div
               className={cn(
             ...
             <div
               className={cn(
                 ...
                 isActive ? "border-ios-blue/50" : "border-foreground/20"
               )}
             />
